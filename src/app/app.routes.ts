...
export const routes: Routes = [
  ...
  {
    path: 'routes',
    loadComponent: () => import('./components/routes/routes-list.component').then(m => m.RoutesListComponent),
    data: { titleKey: 'ROUTES.TITLE', descriptionKey: 'ROUTES.DESC' }
  },
  {
    path: 'routes/:id',
    loadComponent: () => import('./components/routes/route-detail.component').then(m => m.RouteDetailComponent),
  ...
  {
    path: 'drivers/:id',
    loadComponent: () => import('./components/driver/driver-profile.component').then(m => m.DriverProfileComponent),
    // Dynamic titles will be handled in the component
  },
  {
    path: 'driver/register',
    loadComponent: () => import('./components/driver/driver-register.component').then(m => m.DriverRegisterComponent),
    data: { titleKey: 'DRIVER_REG.TITLE', descriptionKey: 'DRIVER_REG.DESC' }
  },
  {
    path: 'driver/dashboard',
    loadComponent: () => import('./components/driver/driver-dashboard.component').then(m => m.DriverDashboardComponent),
  ...
  {
    path: 'waiting',
    loadComponent: () => import('./components/waiting/waiting.component').then(m => m.WaitingComponent),
    data: { titleKey: 'WAITING.TITLE', descriptionKey: 'WAITING.DESC' }
  },
  {
    path: 'review-by-plate',
    loadComponent: () => import('./components/shared/review-by-plate/review-by-plate.component').then(m => m.ReviewByPlateComponent),
    data: { titleKey: 'REVIEW.TITLE', descriptionKey: 'REVIEW.DESC' }
  },
  {
    path: 'my-route',
    loadComponent: () => import('./components/my-route/my-route.component').then(m => m.MyRouteComponent),
    data: { titleKey: 'MY_ROUTE.TITLE', descriptionKey: 'MY_ROUTE.SUBTITLE' }
  },
  {
    path: '**',
    redirectTo: ''
